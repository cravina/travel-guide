...
export default function App() {
  ...
  const [selectedDate, setSelectedDate] = useState('2025-09-23'); // Default to Wed Sep 23 to view Dallas Divide
  ...
  const currentSun = SUN_DATA[selectedDate] || {
    label: selectedDate,
    sunrise: '6:23 AM',
    sunset: '7:08 PM',
    sunriseMin: 383,
  ...
  const tripDates = ['2025-09-23', '2025-09-24', '2025-09-25'];
  const handlePrevDay = () => {
    ...
    <div className="min-h-screen bg-[#E5E9E2] text-slate-900 flex justify-center p-0 sm:p-4 font-sans antialiased selection:bg-[#234E42] selection:text-white">
      ...
      <div className="w-full max-w-md bg-[#F4F6F0] text-slate-900 shadow-2xl flex flex-col relative overflow-hidden sm:rounded-[42px] border-0 sm:border-8 sm:border-slate-800 h-[100dvh] sm:h-[870px]">
        ...
        <div className="px-5 pt-2 pb-3 shrink-0">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="w-8 h-8 rounded-xl bg-white border border-slate-200/80 hover:bg-slate-50 flex items-center justify-center text-slate-600 transition shadow-2xs"
          ...
          <div className="flex items-center space-x-2 mt-3.5">
            <button
              ...
              className="w-9 h-12 rounded-2xl bg-white border border-slate-200/80 hover:bg-slate-50 disabled:opacity-40 disabled:pointer-events-none flex items-center justify-center text-slate-700 shadow-2xs transition shrink-0"
            >
            ...
            <button
              ...
              className="flex-1 h-12 bg-white rounded-2xl border border-slate-200/80 px-3.5 flex items-center justify-between text-left hover:border-[#234E42]/50 transition shadow-2xs"
            >
              <div>
        ...
        {overlaps.length > 0 && (
          <div className="mx-4 mb-2 bg-rose-50 border border-rose-200/90 rounded-2xl p-2.5 flex items-center justify-between text-xs text-rose-800 shadow-xs animate-fade-in">
            ...
            <button
              ...
              className="ml-2 px-2.5 py-1 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-bold text-[11px] shrink-0 shadow-2xs transition"
            >
              Auto Shift
            </button>
          </div>
                    ...
                    >
                      <div className="flex items-start gap-3.5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Activity Badge + Duration Here (Replaced redundant travel metric) */}
          ...
          {activeTab === 'gantt' && (
            <div className="pt-2 select-none">
              ...
              >
                ...
                {settings.showLiveTimeline && selectedDate === '2025-09-23' && (
                  <div
        ...
        <div className="bg-white border-t border-slate-200 px-6 py-2 flex items-center justify-around shrink-0 z-20">
          ...
          <button
            onClick={() => setShowSettingsModal(true)}
            className="flex flex-col items-center space-y-1 text-slate-400 hover:text-slate-600 transition"
          >
            ...
            <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
              ...
              <div className="px-5 py-3.5 bg-[#F4F6F0] border-b border-slate-200 flex items-center justify-between shrink-0">
                ...
                <button
                  ...
                  className="p-1 rounded-xl hover:bg-slate-200 text-slate-500 transition"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`py-2 px-1 rounded-xl font-bold text-xs flex flex-col items-center justify-center space-y-1 transition border ${
                            isSelected
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['none', 'arrival', 'departure'].map((opt) => (
                      <button
                        ...
                        className={`py-1.5 rounded-xl font-bold text-[11px] capitalize border transition ${
              ...
              <div className="p-4 bg-[#F4F6F0] border-t border-slate-200 flex items-center space-x-2 shrink-0">
                <button
                  onClick={() => setEditingItem(null)}
                  className="flex-1 py-2.5 rounded-xl border border-slate-300 text-slate-700 font-bold hover:bg-white transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-[#234E42] hover:bg-[#1B3E34] disabled:opacity-50 text-white font-bold transition shadow-md shadow-[#234E42]/20"
                >
                  Save & Ripple
                </button>
              </div>
            ...
            <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
              <div className="relative h-44 w-full bg-slate-800">
                ...
                <button
                  ...
                  className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/40 text-white hover:bg-black/60 flex items-center justify-center backdrop-blur-md transition"
                >
                  <X className="w-5 h-5" />
                </button>
              ...
              <div className="p-4 bg-[#F4F6F0] border-t border-slate-200 flex items-center space-x-2 shrink-0">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-[#234E42] hover:bg-[#1B3E34] text-white font-bold flex items-center justify-center space-x-1.5 shadow-md shadow-[#234E42]/20 transition"
                >
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl border border-rose-200 text-rose-600 hover:bg-rose-50 font-bold transition"
                >
                  Delete
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4">
            <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden max-h-[85vh] flex flex-col">
              ...
              <div className="p-5 space-y-4 text-xs">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl border border-slate-300 text-slate-600 hover:bg-slate-50 font-bold transition flex items-center justify-center space-x-1.5"
                  >
              ...
              <div className="p-4 bg-[#F4F6F0] border-t border-slate-200 shrink-0">
                <button
                  onClick={() => setShowSettingsModal(false)}
                  className="w-full py-2.5 bg-[#234E42] text-white rounded-xl font-bold shadow-md shadow-[#234E42]/20 hover:bg-[#1B3E34] transition"
                >
                  Done
                </button>
              </div>
